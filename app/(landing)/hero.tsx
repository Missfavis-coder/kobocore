    ...
    <section className="w-full min-h-[65vh] flex items-center justify-center mt-38 px-6">
      <div className="max-w-4xl text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
          ...
          <Link
            href="/signup"
            className="px-6 py-3 md:text-[15px] text-sm text-white bg-cyan-500 hover:bg-cyan-600 font-semibold rounded-xl transition"
          >
            Get Started
          </Link>
          ...
          <Link
            href="/about"
            className="px-6 py-3 md:text-[15px] text-sm border border-cyan-600 hover:border-gray-500 text-gray-600 dark:text-neutral-300 rounded-xl transition"
          >
            Learn More
          </Link>
        </div>
