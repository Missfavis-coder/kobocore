...
export default function Hero() {
  return (
    <section className="w-full max-h-[65vh] flex items-center justify-center mt-38 px-6">
      <div className="max-w-4xl text-center space-y-6">
        ...
        <h1 className="text-2xl md:text-4xl font-bold lg:leading-12 tracking-wider md:tracking-wide dark:text-white">
          ...
          <span className="text-cyan-500 italic font-heading ">KoboCore</span>
        </h1>

        <p className="text-[14px] font-body md:text-[15px] text-slate-700 dark:text-cyan-50 font-body tracking-wider ">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
          ...
          <Link
            href="/about"
            className="px-8 py-3 md:text-[15px] text-sm border border-cyan-600 hover:border-gray-500 text-gray-600 dark:text-neutral-300 rounded-full transition"
          >
            Learn More
          </Link>
        </div>
